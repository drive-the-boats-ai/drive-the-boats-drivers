...
{
    /* Initialize I2C0 */
    PLIB_I2C_BaudRateSet(I2C_ID_1, SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_2), 350000);
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_I2C1_MASTER, INT_PRIORITY_LEVEL1);

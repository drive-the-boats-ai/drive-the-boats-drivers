...
void DRV_OC0_Initialize(void)
{
    ...
    PLIB_OC_Buffer16BitSet(OC_ID_1, 37500);
    PLIB_OC_PulseWidth16BitSet(OC_ID_1, 37500);
}
...
void DRV_OC1_Initialize(void)
{
    ...
    PLIB_OC_Buffer16BitSet(OC_ID_2, 37500);
    PLIB_OC_PulseWidth16BitSet(OC_ID_2, 37500);
}
